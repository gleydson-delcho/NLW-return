...
const Steps = ( { onFeedbackResetRequested}: FeedbackSuccessProps) => {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10  w-[304px]">
        ...
        focus:ring-offset-2 focus:ring-offset-zinc-500 focus:ring-brand-500 ">
          Quero enviar outro eedback
        </button>
      </div>
    </>
  );
